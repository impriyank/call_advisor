	...
	public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException 
	{
		...
		if (ACTION.equals(action)) {
			try {
				...
				if (data!=null) {
					String d = data.getString("strLimit");
			...
			try {
				if (data!=null) {
					Log.d(TAG, "Contact:" + data.getString("contactNumber"));
					viewContact(data.getString("contactNumber"));
				} 
			} catch (JSONException jsonEx) {
				Log.d(TAG, "Got JSON Exception " + jsonEx.getMessage());
				result = new PluginResult(Status.JSON_EXCEPTION);
			...
			try {
				String contactInfo = getContactNameFromNumber(data.getString("contactNumber"));
				Log.d(TAG, "ContactNumber:" + data.getString("contactNumber"));
